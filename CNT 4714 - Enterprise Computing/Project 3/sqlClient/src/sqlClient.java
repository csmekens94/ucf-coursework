...
public class sqlClient {
	...
	static String [] dbConnectComboBoxOptions_Database_URLs = new String[] { "jdbc:mysql://localhost:3306/project3", "jdbc:mysql://localhost:3306/project4" };
	...
	public static void setGui()
	{
		...
		windowFrame.setTitle("SQL Client GUI - (RMA)");
